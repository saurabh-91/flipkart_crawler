...
<!--
    <?php if($ret_array[2][0]) echo '<input  type="checkbox" name="price_range[]" value="8888"   '?><?php if(isset($_POST["price_range"][0])) echo SHOWCHECKED;?><?php if($ret_array[2][0]) echo ' >0-10000  <br>' ?>
    <?php if($ret_array[2][1]) echo '<input  type="checkbox" name="price_range[]" value="18888"  '?><?php if(isset($_POST["price_range"][1])) echo SHOWCHECKED;?><?php if($ret_array[2][1]) echo '  >10000-20000 <br>' ?>
    <?php if($ret_array[2][2]) echo '<input  type="checkbox" name="price_range[]" value="28888"  '?><?php if(isset($_POST["price_range"][2])) echo SHOWCHECKED;?><?php if($ret_array[2][2]) echo ' >20000-35000 <br>' ?>
    <?php if($ret_array[2][3]) echo '<input  type="checkbox" name="price_range[]" value="38888"  '?><?php if(isset($_POST["price_range"][3])) echo SHOWCHECKED;?><?php if($ret_array[2][3]) echo '>35000-50000 <br>' ?>
    <?php if($ret_array[2][4]) echo '<input  type="checkbox" name="price_range[]" value="48888"  '?><?php if(isset($_POST["price_range"][4])) echo SHOWCHECKED;?><?php if($ret_array[2][4]) echo '>50000 and above <br>' ?>
...
<!--  <H1>ram</H1>
    <?php if($ret_array[4][0]) echo '<input  type="checkbox" name="ram_range[]" value=".5"   '?><?php if(isset($_POST["ram_range"][0])) echo SHOWCHECKED;?><?php if($ret_array[4][0]) echo ' >less than 1 GB  <br>' ?>
    <?php if($ret_array[4][1]) echo '<input  type="checkbox" name="ram_range[]" value="1.5"  '?><?php if(isset($_POST["ram_range"][1])) echo SHOWCHECKED;?><?php if($ret_array[4][1]) echo ' >1 GB - 2GB <br>' ?>
    <?php if($ret_array[4][2]) echo '<input  type="checkbox" name="ram_range[]" value="2.5"  '?><?php if(isset($_POST["ram_range"][2])) echo SHOWCHECKED;?><?php if($ret_array[4][2]) echo ' >2 GB - 3GB <br>' ?>
    <?php if($ret_array[4][3]) echo '<input  type="checkbox" name="ram_range[]" value="3.5"  '?><?php if(isset($_POST["ram_range"][3])) echo SHOWCHECKED;?><?php if($ret_array[4][3]) echo ' >3 GB - 4GB <br>' ?>
    <?php if($ret_array[4][4]) echo '<input  type="checkbox" name="ram_range[]" value="4.5"  '?><?php if(isset($_POST["ram_range"][4])) echo SHOWCHECKED;?><?php if($ret_array[4][4]) echo ' >4 GB and above <br>' ?>
-->
