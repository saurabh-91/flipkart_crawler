...
// ######################################### main function (execution start from here) ########################################################
    public function perform_es($user_query_string, $term_filter_input_array, $range_filter_input_array, $iquery, $page_no)//depend on user input which opretion to perform
    {
